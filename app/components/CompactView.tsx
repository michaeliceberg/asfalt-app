...
// Функция для проверки активных отгрузок сегодня
  ...
  if (shouldUseCombined && combinedLoading) {
    return (
      <div className="compact-view">
        <ActivityChart shipments={[]} selectedFactory={selectedFactory} mode={mode} />
    ...
    return (
      <div className="compact-view">
        {allShipmentsForChart && allShipmentsForChart.length > 0 && (
          <ActivityChart shipments={allShipmentsForChart} selectedFactory={selectedFactory} mode={mode} />
        )}
            ...
            <div key={date} className="compact-date-group">
              ...
              <div className="compact-table">
                ...
                {sortedItems.map((item, idx) => {
                  ...
                  return (
                    <div key={idx}>
                      <div className="compact-row compact-clickable" onClick={() => setExpandedId(isExpanded ? null : itemKey)}>
