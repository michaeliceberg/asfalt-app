...
//     const allShipments: ShipmentItem[] = await response.json();
    
//     const today = new Date();
//     today.setHours(0, 0, 0, 0);
    
//     const todayShipments = allShipments.filter((shipment: ShipmentItem) => {
...
// };
  ...
  const loadFutureRequestsCount = async () => {
    try {
      ...
      const future = allRequests.filter((req: OutgoingRequest) => {
